...
function Skills() {
  const skills = [
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-12 h-12">
          <path fill="currentColor" d="M248 503.7C246.5 503.9 245 504 243.5 504C241.9 504 240.5 503.9 239 503.7C181.8 487.3 65.8 386.8 65.8 253.4C65.8 162.9 139.4 89.3 229.9 89.3C320.4 89.3 394 162.9 394 253.4C394 386.8 278 487.3 248 503.7zM229.9 128.4C161.1 128.4 104.9 184.6 104.9 253.4C104.9 354.8 189.7 434.5 239 456.5C288.3 434.5 373.1 354.8 373.1 253.4C373.1 184.6 316.9 128.4 248.1 128.4H229.9z"/>
        </svg>
      ),
    },
    {
      ...
      <div className="max-w-6xl mx-auto px-4 w-full">
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8'>
          {skills.map((skill, index) => (
            <div 
              key={index}
              className="flex flex-col items-center justify-center p-8 border-2 border-black rounded-xl hover:bg-black hover:text-white transition-all group"
            >
              <div className="group-hover:text-white transition-colors">
                {skill.icon}
              </div>
              <h3 className="mt-4 text-xl font-mono font-bold">{skill.name}</h3>
            </div>
          ))}
        </div>
      </div>
